<div class="mx-auto w-3/4 xl:w-1/2 [&>h1]:text-center [&>h1]:text-lg">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Application</strong> refers to Knot, the software program provided by the Company.
			</p>
		</li>
		<li>
			<p>
				<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
				or &quot;Our&quot; in this Privacy Policy) refers to Knot.
			</p>
		</li>
		<li>
	...
	<ul>
		...
		<li>
			<p>
				<strong>For business transfers:</strong> We may use Your Personal Data to evaluate or conduct
				a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of
	...
	<ul>
		<li>
			<strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers
		...
		<li>
			<strong>With Affiliates:</strong> We may share Your Personal Data with Our affiliates, in which
	...
	<ul>
		...
		<li>
			...
			<ul>
				<li>
					<p>
						Application usage statistics: up to 24 months to understand feature adoption and service
						improvements.
					</p>
				</li>
				<li>
	...
	<ul>
		<li>
			By email: <a
				href="mailto:info@edsail.com"
				class="__cf_email__"
				data-cfemail="bad3d4dcd5fadfdec9dbd3d694d9d5d7">[email&#160;protected]</a
			>
		</li>
	</ul>
</div>
